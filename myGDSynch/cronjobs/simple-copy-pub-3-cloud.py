...
# SimpleCopyPub2Cloud.py
# A pure Gemini cheat

# TESTING
# # cd /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs
# chmod +x simple-copy-pub-2-cloud.py
# bad # > /home/jku/usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/

# > /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/

# RELEASE
# > /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/python3 simple-copy-pub-2-cloud.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/
...
def copy_dir(src, dest, verbose):
  ...
  Usage:
    test:
      /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/ 1
    release:
      /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/ 0
  cronjob:
    test:
      10 * * * * /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/ 1
    release:
      10 * * * * /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/simple-copy-pub-2-cloud.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/ 0
...
if __name__ == "__main__":
  ...
  if len(sys.argv) != 4:
    print("Begin - Error - Usage: python simple-copy-pub-2-cloud.py " + script_dir + "\n Were there 3 args passed? Source, Destination, Verbose (0|1)")
    logger.info("Begin - Error - Usage: python simple-copy-pub-2-cloud.py " + script_dir)
