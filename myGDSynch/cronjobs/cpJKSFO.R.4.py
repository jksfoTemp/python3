...
# chmod +x cpJKSFO.R.4.py
# bad # > /home/jku/usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/

# > /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/

# RELEASE
# > /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/python3 cpJKSFO.R.4.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/
...
def copy_dir(src, dest, verbose):
  ...
  Usage:
    test:
      /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/ 1
    release:
      /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/ 0
  cronjob:
    test:
      10 * * * * /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/WorkTEST/ ~/JKSFO.Resume/WorkTEST/ 1
    release:
      10 * * * * /usr/bin/python3 /home/jku/MyHome/Code/projects/sandbox/python3/myGDSynch/cronjobs/cpJKSFO.R.4.py ~/MyHome/Pers/Work/ ~/JKSFO.Resume/Work/ 0
...
if __name__ == "__main__":
  ...
  if len(sys.argv) != 4:
    print("Begin - Error - Usage: python cpJKSFO.R.4.py " + script_dir + "\n Were there 3 args passed? Source, Destination, Verbose (0|1)")
    logger.info("Begin - Error - Usage: python cpJKSFO.R.4.py " + script_dir)
